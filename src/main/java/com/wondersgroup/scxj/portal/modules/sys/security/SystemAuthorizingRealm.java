...
import com.wondersgroup.scxj.portal.common.utils.Encodes;
...
import com.wondersgroup.scxj.portal.modules.sys.web.LoginController;
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		if(getAvailablePrincipal(principals) instanceof Principal){
			...
			if (user != null) {
				...
				return info;
			} else if(getAvailablePrincipal(principals) instanceof OpenIdAuthentication){
				UserUtils.putCache(UserUtils.CACHE_LAWYER_PERSON_ID, "");//TODO
				SimpleAuthorizationInfo info = new SimpleAuthorizationInfo();
				List<Menu> list = UserUtils.getMenuList();
				for (Menu menu : list){
					if (StringUtils.isNotBlank(menu.getPermission())){
