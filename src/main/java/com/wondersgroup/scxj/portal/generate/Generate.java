 ...
 */
package com.wondersgroup.scxj.portal.generate;
...
import com.wondersgroup.scxj.portal.common.utils.FileUtils;
import com.wondersgroup.scxj.portal.common.utils.FreeMarkers;
...
public class Generate {
	...
	public static void main(String[] args) throws Exception {
		...
		String packageName = "com.wondersgroup.scxj.portal.modules";
		
		String moduleName = "law";			// 模块名，例：sys
		String subModuleName = "";				// 子模块名（可选） 
		String className = "WcmCase";			// 类名，例：user
		String classAuthor = "LiRiChen";		// 类作者，例：LiRiChen
		String functionName = "案件信息";			// 功能名，例：用户
		...
		// 模板文件路径
		String tplPath = StringUtils.replace(projectPath+"/src/main/java/com/wondersgroup/scxj/portal/generate/template", "/", separator);
