...
<body id="list_body">
<form  id="ssywapply" name="ssywapply"  action="/l/lawyer/wcmdocument/ssyw/apply" method="POST" enctype="multipart/form-data">
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td class="all_title_bg">诉讼业务>>在线预约</td>
        ...
        <td width="50%" valign="top" rowspan="2" class="choose_bg">
         ...
         <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
  			<tr>
  				...
  				<td width="50%" align="center">
  					<ul class="choose_menu">
		              <li class="chooseinput"><input type="text" name="suspectsName" id="suspectsName" class="inputform" /></li>
		              <li class="chooseinput" style="height: 60px;"><textarea name="brief" id="brief" class="inputform" style="height: 56px;line-height: 20px;"></textarea></li>
					  ...
					  <li class="chooseinput">
					  <span class="inputform" style="border:0;overflow:hidden;height:30px;">
  						<select name="caseType" id="caseType" class="inputform" style="margin:-1px;" onChange="javascritp:if(this.value=='批捕阶段'){alert('请在审查批捕期限届满前三天申请预约!')};document.getElementById('APPLYMATTERTYPENUM').value='';javascritp:document.getElementById('applyMatterType').value='';">
								  <option value="">请选择</option>
		              ...
		              <li class="chooseinput" style="height: 60px;">
		              	<table border="0" align="center" cellpadding="0" cellspacing="0">
		              		<tr>
		              			...
		              			<td width="*"><input class="inputform" name="fileZyz" type="file"  id="fileSfz1"/></td>
		              		</tr>
		              	</table>
		              </li>
		              <li class="chooseinput" style="height: 60px;">
		              	<table border="0" align="center" cellpadding="0" cellspacing="0">
		              		<tr>
		              			...
		              			<td width="*"><input class="inputform" name="filelsh" type="file"  id="fileSfz2"/></td>
		              		</tr>
		              	</table>
		              </li>
		              <li class="chooseinput" style="height: 60px;">
		              	<table border="0" align="center" cellpadding="0" cellspacing="0">
		              		<tr>
		              			...
		              			<td width="*"><input class="inputform" name="filewts" type="file"  id="fileSfz3"/></td>
		              		</tr>
		              	</table>
		              </li>
		              <li class="chooseinput" style="height: 60px;">
		              	<table border="0" align="center" cellpadding="0" cellspacing="0">
		              		<tr>
		              			...
		              			<td width="*"><input class="inputform" name="filecx" type="file"  id="fileSfz4"/></td>
		              		</tr>
		              	</table>
		              </li>
		              <li class="chooseinput" style="height: 60px;">
		              	<table border="0" align="center" cellpadding="0" cellspacing="0">
		              		<tr>
		              			...
		              			<td width="*"><input class="inputform" name="filegx" type="file"  id="fileSfz5"/></td>
		              		</tr>
		              	</table>
		              </li>
		              <li class="chooseinput" style="height: 60px;"><textarea name="reservation" id="reservation" class="inputform" style="height: 56px;line-height: 20px;border:0"></textarea></li>
      ...
      <td width="*" valign="top" class="choose_bg">
        ...
        <table width="96%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#dddddd" style="margin-top: 8px;">
              ...
              <tr class="yw_list_tr border_none">
                ...
                <td align="center" bgcolor="#fffbdd"><input type="text" name="lawyerTel" id="lawyerTel" class="inputform" value="${lawyerUser.mobile}"/></td>
              </tr>
              <tr class="yw_list_tr border_none">
                <td align="center" class="lsxx"><span class="fontcol">*</span>联系Email：</td>
                <td align="center" bgcolor="#fffbdd"><input type="text" name="lawyerEmail"  id="lawyerEmail" class="inputform" value="${lawyerUser.email}"  /></td>
              </tr>
              <tr class="yw_list_tr border_none">
...
$("#fileSfz3").change(function(){
	preview('preview3',this);
});
$("#fileSfz4").change(function(){
	preview('preview4',this);
});
$("#fileSfz5").change(function(){
	preview('preview5',this);
});
...
function submitForm(){
	...
	if($("#fileSfz1").val()==null || $("#fileSfz1").val()==""){
		alert("请选择执业证！");
		return false;
	}if($("#fileSfz2").val()==null || $("#fileSfz2").val()==""){
		alert("请选择律所函！");
		return false;
	}if($("#fileSfz3").val()==null || $("#fileSfz3").val()==""){
		alert("请选择委托书！");
		return false;
	}
