...
<body>
<ul class="menu">
<li id="menu1" onclick="setNav('menu',1,2)" class="hover"><a href="/l/lawyer/wcmdocument/jcyTree/ssyw" target="rightFrame">在线预约</a></li>
<li id="menu2" onclick="setNav('menu',2,2)"><a href="/l/lawyer/wcmdocument/ajax/ssyw_list" target="rightFrame">在线查询</a></li>
</ul>
</body>
</html>
