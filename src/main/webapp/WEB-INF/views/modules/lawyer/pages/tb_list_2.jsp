...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr class="list_tr">
    ...
    <td align="center">已填报</td>
    <td align="center"><a href="tb_list_3.html">查看</a> <a href="javascript:void(0)" onClick="select_changed()">历史</a></td>
  </tr>
  
  <tr style="display:none" id="nextOption">
    <td colspan="7">
    
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr class="list_tr_sub">
    <td width="6%" align="center">1</td>
    <td width="36%" align="center">监督工作记录</td>
    <td width="12%" align="center">区卫生局</td>
    <td width="13%" align="center">05-05</td>
    <td width="13%" align="center">05-09</td>
    <td width="8%" align="center">已填报</td>
    <td width="12%" align="center"><a href="/l/lawyer/wcmdocument/tb_list_3">查看</a></td>
  </tr>
  <tr class="list_tr_sub">
  ...
  <tr class="list_tr">
    ...
    <td align="center">06-09</td>
    <td align="center">已填报</td>
    <td align="center"><a href="/l/lawyer/wcmdocument/tb_list_3">查看</a> <a href="#">历史</a></td>
  </tr>
  <tr class="list_tr">
    <td align="center">3</td>
