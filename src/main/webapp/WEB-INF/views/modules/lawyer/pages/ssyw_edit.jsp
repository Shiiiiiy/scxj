...
<form  id="ssywapply" name="ssywapply"  action="/l/lawyer/wcmdocument/ssyw/edit" method="POST" enctype="multipart/form-data">
<input type="hidden" name="id"   value="${lawyerApply.id}" />
<input type="hidden" name="groupId"   value="${lawyerApply.groupId}" />
<input type="hidden" name="groupName" value="${lawyerApply.groupName}" />
<input type="hidden" id="applyMatterType" name="applyMatterType" value=""/>
<input type="hidden" id="orderDate" name="orderDate" value="${lawyerApply.orderDate}">
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td class="all_title_bg">诉讼业务>>修改</td>
         ...
         <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
  			<tr>
  				<td width="50%" align="center">
		              ...
		              <li class="choose" style="height: 60px;"><span class="fontcol"></span>执业证：</li>
		              <li class="choose" style="height: 60px;"><span class="fontcol"></span>律所函：</li>
		              <li class="choose" style="height: 60px;"><span class="fontcol"></span>委托书：</li>
  				...
  				<td width="50%" align="center">
  					<ul class="choose_menu">
  					  <li class="chooseinput"><input type="text" name="suspectsName" id="suspectsName" class="inputform" value="${lawyerApply.suspectsName}"/></li>
		              <li class="chooseinput" style="height: 60px;"><textarea name="brief" id="brief" class="inputform" style="height: 56px;line-height: 20px;">${lawyerApply.brief}</textarea></li>
		              <li class="chooseinput">
		              <span class="inputform" style="border:0;overflow:hidden;height:30px;">
		              	<select name="relation" id="relation" class="inputform">					  
		              ...
		              <li class="chooseinput" style="height: 60px;"><textarea name="reservation" id="reservation" class="inputform" style="height: 56px;line-height: 20px;">${lawyerApply.reservation}</textarea></li>
      ...
      <td width="*" valign="top" class="choose_bg">
        ...
        <table width="96%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#dddddd" style="margin-top: 8px;">
              ...
              <tr class="yw_list_tr border_none">
                ...
                <td align="center" bgcolor="#fffbdd"><input type="text" name="lawyerTel" id="lawyerTel" class="inputform" value="${lawyerApply.lawyerTel}"/></td>
              </tr>
              <tr class="yw_list_tr border_none">
                <td align="center" class="lsxx"><span class="fontcol">*</span>联系Email：</td>
                <td align="center" bgcolor="#fffbdd"><input type="text" name="lawyerEmail"  id="lawyerEmail" class="inputform" value="${lawyerApply.lawyerEmail}"  /></td>
              </tr>
              <tr class="yw_list_tr border_none">
...
function setAllValue(){
	$("#relation option").each(function(){
	    if($(this).val()=='${lawyerApply.relation}'){
	        $(this).attr('selected',true);
	    }
	});
	$("#caseType option").each(function(){
	    if($(this).val()=='${lawyerApply.caseType}'){
	        $(this).attr('selected',true);
	    }
	});
	
	var caseTypeValue='${lawyerApply.caseType}';
	var applyMatterValue='${lawyerApply.applyMatterType}'.split('；');
	if(caseTypeValue=="侦查阶段"){
		$("#jcjd input").each(function(){
		    for(var j=0;j<applyMatterValue.length;j++){
		    	var str=applyMatterValue[j]+"；";
		    	if($(this).val()==str){
	...
	var thisValue='${lawyerApply.orderDate}'.split('或');
	var s=document.getElementById("s_orderDate");  
	for(var j=0;j<thisValue.length;j++){
		var thisVal =thisValue[j]+" 或 ";
		s.options[s.options.length] = new Option(thisVal,thisVal);
	}
...
function setValue(num){
	...
	if(document.getElementById(id).checked){
			...
			$("#APPLYMATTERTYPENUM").val(typeNumValue);			
		}else{
