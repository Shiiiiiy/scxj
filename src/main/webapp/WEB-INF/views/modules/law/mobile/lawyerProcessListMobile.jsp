...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			openLawyerSearchList();
		});

	    function openLawyerSearchList() {
	        var pid = $("#personid").val();
	        var searchappid = $("#searchappid").val();
	        var lisensenumber = $("#lisensenumber").val();
	        AndroidFunction.openLawyerSearchList(searchappid, pid,lisensenumber);
	    }
	</script>
</head>
<body>
	...
	<form:form id="searchForm" modelAttribute="searchApply" action="${ctx}/law/apply/save" method="post" class="form-horizontal">
